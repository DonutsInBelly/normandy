...
async function runCIC(
  ...
  console.log("  \x1b[36m╠══════════════════════════════════════════╣\x1b[0m");
  console.log("  \x1b[36m║\x1b[0m  \x1b[33mSquad:\x1b[0m                                   \x1b[36m║\x1b[0m");
  console.log("  \x1b[36m║\x1b[0m    Tali     -- Web Apps (React, Next.js)  \x1b[36m║\x1b[0m");
  console.log("  \x1b[36m║\x1b[0m    Garrus   -- Games (Phaser, Unity)      \x1b[36m║\x1b[0m");
  console.log("  \x1b[36m║\x1b[0m    Liara    -- Mobile (RN, Flutter)       \x1b[36m║\x1b[0m");
  console.log("  \x1b[36m║\x1b[0m    Miranda  -- Code Review                \x1b[36m║\x1b[0m");
  console.log("  \x1b[36m║\x1b[0m    Mordin   -- Architecture & Design      \x1b[36m║\x1b[0m");
  console.log("  \x1b[36m╠══════════════════════════════════════════╣\x1b[0m");
  ...
  const prompt = () => {
    rl.question("  \x1b[36mShepard>\x1b[0m ", async (input) => {
      ...
      if (trimmed === "/help") {
        ...
        console.log("");
        console.log("  \x1b[33mSquad Members:\x1b[0m");
        console.log("    Tali'Zorah    -- Web applications (React, Next.js, Vue)");
        console.log("    Garrus        -- Video games (Phaser, Unity, Godot)");
        console.log("    Liara         -- Mobile apps (React Native, Flutter, Swift)");
        console.log("    Miranda       -- Code review & quality assurance");
        console.log("    Mordin        -- Architecture & system design");
        console.log("");
      ...
      if (trimmed === "/squad") {
        ...
        console.log("  \x1b[36mTali'Zorah vas Normandy\x1b[0m  -- Chief Engineer");
        console.log("    Web apps: React, Next.js, Vue, Angular, Tailwind");
        console.log("  \x1b[36mGarrus Vakarian\x1b[0m          -- Calibration Expert");
        console.log("    Games: Phaser, Three.js, Unity C#, Godot");
        console.log("  \x1b[36mLiara T'Soni\x1b[0m             -- Information Specialist");
        console.log("    Mobile: React Native, Flutter, Swift, Kotlin");
        console.log("  \x1b[36mMiranda Lawson\x1b[0m           -- Perfectionist Operative");
        console.log("    Code review, security audit, quality assurance");
        console.log("  \x1b[36mMordin Solus\x1b[0m             -- Scientist");
        console.log("    Architecture, system design, technical specs");
        console.log("");
        prompt();
        return;
      }
